<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="availableThesis2.aspx.cs" Inherits="WebApplication2.availableThesis2" %>
...
<body>
    ...
    <asp:Table ID="Supervisor" runat="server"  CellPadding="5"
            CellSpacing="25" Height="100px" BorderWidth="10" BackColor =" White"
                ...
                BackColor="#00008b"
                Font-Bold="true">
                    <asp:TableHeaderCell CssClass="id" Text="Serial Number">
